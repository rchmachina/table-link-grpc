...
type AuthClient interface {
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*ResponseRequest, error)
...
func (c *authClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*ResponseRequest, error) {
...
type AuthServer interface {
	Login(context.Context, *LoginRequest) (*ResponseRequest, error)
...
func (UnimplementedAuthServer) Login(context.Context, *LoginRequest) (*ResponseRequest, error) {
